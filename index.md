...
*Note: In the published version, some equation references are off by 1. For example, it says (10) when it should be (9). This is fixed in the working paper versions below.*
...
[Working paper PDF](/assets/files/RationingUnderStickyPrices.pdf){: .btn .btn--danger} [Slides](/assets/files/RationingUnderStickyPricesSlides.pdf){: .btn .btn--danger} [Short slides (older)](/assets/files/RationingUnderStickyPricesSlidesShort.pdf){: .btn .btn--danger}
